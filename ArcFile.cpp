...
//////////////////////////////////////////////////////////////////////////////////////////
//	Simple initialization fo the decryption key
//
//	Note: Text-only data
	...
	)
{
	...
	dwResult = m_clfOutput.Write( pvBuffer, dwWriteSize );
...
void	CArcFile::ReplaceBackslash(
	LPTSTR				pszPath
	)
{
	while( *pszPath != _T('\0') )
	...
	)
{
	...
	while( nLow <= nHigh )
	{
		...
		nResult = lstrcmpi( pszFileName, rvcFileInfo[nMid].name );

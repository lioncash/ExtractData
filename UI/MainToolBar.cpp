...
HWND CMainToolBar::Create(HWND hWnd)
{
	...
	TBBUTTON space = {0, 0, TBSTATE_ENABLED, BTNS_SEP, 0, 0};
...
HWND CSearchToolBar::Create(HWND hWnd)
{
	std::array<TBBUTTON, 9> buttons{{
		...
		{3, IDM_MID, TBSTATE_ENABLED, BTNS_CHECK, 0, 0},
		{4, IDM_MPG, TBSTATE_ENABLED, BTNS_CHECK, 0, 0},
		{5, IDM_OGG, TBSTATE_ENABLED, BTNS_CHECK, 0, 0},
		{6, IDM_PNG, TBSTATE_ENABLED, BTNS_CHECK, 0, 0},
		{7, IDM_WAV, TBSTATE_ENABLED, BTNS_CHECK, 0, 0},
		{8, IDM_WMV, TBSTATE_ENABLED, BTNS_CHECK, 0, 0}
	}};
